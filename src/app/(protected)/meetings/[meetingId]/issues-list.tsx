...
import { BookOpenText, Loader, VideoIcon } from "lucide-react";
  ...
  return (
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 gap-2 sm:grid-cols-3">
        {meeting.Issues.map((issue, indx) => (
          <IssueCard key={indx} issue={issue} />
        ))}
      </div>
    </div>
  );
...
function IssueCard({
  ...
  return (
    <>
      ...
      <Card className="relative flex flex-col justify-between shadow-lg transition-transform hover:scale-[1.02] hover:shadow-xl">
        <CardHeader>
